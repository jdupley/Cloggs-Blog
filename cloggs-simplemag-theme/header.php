...
<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
    ...
    <section id="site"<?php echo isset( $site_layout ) ? $site_layout : ''; ?>>
        <div class="site-content">
			...
			-->
				<link rel="stylesheet" type="text/css" href="https://media.clothingsites.co.uk/media/clientstyles/scripts/CSPN/CSPN.css">
				
				<!-- 0 = woodhouse / 1 = bbclothing -->
				<div id="CSPN-header" data-site="0"><!-- default content, replaced on successful content load --></div>
